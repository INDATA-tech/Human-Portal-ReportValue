...
var guclu_yanlarin_46_29_eng_1 = "The Strength of “Discovery” Quantum 29-46";
...
var guclu_yanlarin_5_eng_1 = "Atmosphere Setter";
var guclu_yanlarin_5_eng_2 = "Creating an Inclusive and Effective Environment You have a natural ability to establish the culture of a group, helping to set norms, values, and behaviors that create a strong internal environment. Whether it’s organizing how a group operates, guiding the way people interact, or setting dress codes and meeting times, your influence helps create an atmosphere of consistency and professionalism.\n\nShaping Group Identity Your skill lies in shaping how a group defines itself, from how people communicate to what they focus on. You help to form the unspoken rules of the group, ensuring that everyone understands \"the way things are done here.\" This consistency promotes successful behaviors and a sense of belonging within the group.\n\nSupporting Success Through Structure By creating reliable patterns and norms, you foster an environment where individuals feel secure and supported. These established practices lead to efficiency and better group dynamics, allowing team members to thrive. Your role in shaping these patterns of behavior is crucial to maintaining a successful and cohesive working environment.\n\nUsing Your Skill in Business In business, your skill in setting the atmosphere and culture is valuable for roles like human resources, team management, and organizational development. By fostering a cohesive culture, you help build environments where teams perform well, trust each other, and meet common goals. Your ability to instill consistent practices ensures that the internal operations of a group run smoothly and effectively, helping both the organization and its employees succeed.\n\n"

var guclu_yanlarin_46_eng_1 = "Group Harmonizer"; 
var guclu_yanlarin_46_eng_2 = "Stabilizing the Group You have a natural ability to bring stability to a group, creating a cohesive and well-functioning team. You help ensure that everyone is focused and ready to tackle tasks, which allows the group’s personality to develop and flourish.\n\nCreating Presence You bring a quality of presence to the group, keeping them focused on the work at hand. Your ability to generate this sense of focus helps the team remain productive and aligned with their goals.\n\nFostering Balance and Harmony You ensure that the group operates in a balanced and harmonious way, making sure everyone feels comfortable interacting with clients, suppliers, and each other. This inner harmony promotes a positive working environment and builds strong external relationships.\n\nAdapting to Change Your coordination skills allow you to help the group adjust to external changes. Whether it’s market shifts or evolving project demands, you help the team adapt smoothly and efficiently, keeping them agile and responsive to new challenges.\n\nUsing Your Skill in Business In the business world, your skill in group coordination and harmonization can be used in roles such as project management, team leadership, and client relations. Your ability to stabilize a group and foster balance helps create productive teams and strong external partnerships. By embracing your adaptability, you can lead your organization through changes and ensure continuous success."; 

var guclu_yanlarin_29_eng_1 = "Purpose Connector";
var guclu_yanlarin_29_eng_2 = "Fostering Team Commitment You possess a natural ability to unify a group by helping everyone align with a common goal. Your presence ensures that everyone is committed to the work at hand, creating a sense of shared purpose and dedication.\n\nInstilling Loyalty and Trust You help build a strong sense of loyalty and belonging within the team. Your ability to foster commitment ensures that everyone feels included and responsible for contributing to the group's success, much like the “All for One, One for All” spirit.\n\nCreating a Dedicated Team Environment Your presence encourages people to work for the good of the team. You help individuals commit to their responsibilities and collaborate harmoniously, which promotes a high level of team cohesion and loyalty.\n\nUsing Your Skill in Business In business, your skill in fostering commitment to a purpose is valuable for team leadership, project management, or HR roles or any team you are part of. Your ability to bring people together to commit to a common goal enhances productivity, builds loyalty, and creates an environment of trust. This strength is crucial for achieving long-term success and keeping teams motivated and focused.";

var guclu_yanlarin_14_eng_1 = "Resource Master";
var guclu_yanlarin_14_eng_2 = "Generating Resources for Success You have the unique ability to attract and generate the resources a business needs to thrive, whether that’s money, people, or essential supplies. Your presence gives the team the confidence that they can back up their promises and deliver on their commitments. This ability ensures that projects move forward and goals are met.\n\nEnsuring Business Success Your contribution creates a sense of security within the team, as people feel that they have the means to achieve what they set out to do. By helping the group generate the cash and resources needed, you provide the foundation for long-term success and stability.\n\nBacking Up Promises When you’re involved, people trust that the group will have what it takes to get the job done. You bring a sense of assurance that everything needed to meet the objectives is available or can be generated, fostering a productive and motivated team.\n\nUsing Your Skill in Business In business, your skills in resources and capacity is vital in roles that focus on resource management, project execution, and financial planning. By helping your team gather the necessary resources, you ensure that businesses stay on track and achieve their goals. This skill is particularly important for leadership roles, ensuring that the entire organization operates efficiently and productively.";

var guclu_yanlarin_2_eng_1 = "Direction Setter";
var guclu_yanlarin_2_eng_2 = "Setting the Direction for Success You have the ability to establish a clear direction for the business, guiding the team on how to best use available resources. Your insight helps the group market their products or services, plan for the future, and manage day-to-day operations with precision. By aligning the team with a shared vision, you ensure that everyone knows where the business is heading and how resources should be allocated to achieve success.\n\nEnabling Growth Your skill in planning and resource management allows the group to see where they need to invest time and money to grow. You help the business prioritize what matters most and allocate resources effectively, ensuring that the team moves in the right direction without wasting time or effort.\n\nResource Management You guide the team in using resources efficiently, helping them understand their capacity and how to use it wisely. Your ability to forecast the best uses for available funds or supplies makes you a critical player in financial and strategic decision-making.\n\nUsing Your Skill in Business In business, your vision and direction setting enables teams to focus on long-term goals while optimizing short-term tasks. Whether you're working in leadership, strategic planning, or financial management, your ability to provide direction helps businesses thrive. By applying your vision to oversee resource allocation, you ensure that projects stay on track, targets are met, and the team remains cohesive.";

var guclu_yanlarin_1_eng_1 = "Sales Catalyst";
var guclu_yanlarin_1_eng_2 = "Turning Vision into Action You possess the unique ability to take a vision and put it into action. Your skill ensures that ideas are transformed into tangible outcomes, such as products or services reaching customers. By implementing creative strategies, you make sure that the group’s efforts result in visible, concrete achievements.\n\nEnsuring Delivery You have the capability to take charge of the final steps in delivering products or services to customers. Whether it’s through effective sales strategies, marketing you guarantee that everything gets out the door, reaching its intended audience.\n\nDriving Results Your strength lies in ensuring that plans turn into results. You bring together the necessary tools, strategies, and team effort to generate sales and grow the business. This ability to transform ideas into real-world outcomes is crucial for any project’s success.\n\nUsing Your Skill in Business In business, your sales skill is very valuable in roles related to marketing and sales. Your ability to creatively manage and execute plans ensures that the group’s vision comes to life, leading to higher productivity and customer satisfaction. By using this skill, you push the organization towards achieving tangible results.";

var guclu_yanlarin_8_eng_1 = "Brand Ambassador";
var guclu_yanlarin_8_eng_2 = "Gaining Visibility and Recognition  You have a natural talent for attracting attention and helping the group stand out. This skill ensures that your team's efforts and achievements are noticed and appreciated. You contribute creatively to promoting the group’s goals, allowing the organization to make a lasting impression.\n\nPromoting the Group’s Work Your ability to showcase the group's work helps create a positive public image. You excel at drawing attention to what the team is doing and presenting it in a way that resonates with others. This helps build a strong, recognizable brand that gains respect and admiration.\n\nDemonstrating and Inspiring You are skilled at stepping forward and demonstrating what the group represents. By showing others how to embody the team’s values and vision, you serve as a role model and leader. This inspires your colleagues and encourages them to contribute their best to the shared goals.\n\nUsing Your Skill in Business In business, this skill is crucial for roles that involve marketing, communication, and brand management. Your ability to attract attention and generate interest can help the team gain recognition, secure opportunities, and establish a strong reputation. By using your skill effectively, you support your organization in building meaningful connections and achieving success.";

var guclu_yanlarin_7_eng_1 = "Strategic Planner";
var guclu_yanlarin_7_eng_2 = "Strategic Forward Thinking You possess the ability to move forward into the future successfully by creating logical, detailed plans. Your skill lies in identifying what needs to happen next and ensuring the right people are doing the right work at the right time. By planning effectively, you enable the group to invest in research, development, and growth to secure future success.\n\nUnderstanding the Market Your planning ability extends beyond the immediate needs of the group. You help identify market trends, understand customer desires, and keep up with industry progress. This insight ensures that the team is always aligned with what the market demands and can pivot when necessary.\n\nEfficient Resource Allocation You excel in organizing schedules and allocating resources efficiently. By ensuring that the right tools, people, and materials are in place, you keep the team focused and productive. Your planning minimizes wasted effort and maximizes output, helping the group meet its goals.\n\nUsing Your Skill in Business In business, your strategic planning skills are valuable in roles that involve strategic planning, operations management, or project management. Your ability to map out a clear path forward ensures that the group stays on track, meets deadlines, and achieves its objectives. By using your skill of planning, you maintain momentum and ensure the long-term success of any business venture.";

var guclu_yanlarin_31_eng_1 = "Implementation Maestro";
var guclu_yanlarin_31_eng_2 = "Executing Plans Efficiently Your strength lies in taking a plan and putting it into action. You ensure that everyone in the group is fulfilling their roles and carrying out the necessary tasks. This skill involves staying organized and on top of things, ensuring that operations run smoothly and goals are met.\n\nAssigning Roles for Success One of your key abilities is to give each team member a role to ensure that the plan is carried out effectively. You focus on making sure the right people are in the right roles, contributing to the success of the project or business.\n\nManaging Business Systems Your skill also involves developing and managing systems that ensure the business runs efficiently. From establishing customer service protocols to creating employee handbooks, you make sure the inner workings of the business are streamlined and productive.\n\nUsing Your Skill in Business In the business world, this skill is valuable in roles that involve project management, team coordination, and customer service. Your ability to organize people and processes helps ensure that plans are executed efficiently, leading to smoother operations and better results.";

var guclu_yanlarin_13_eng_1 = "Numbers Strategist";
var guclu_yanlarin_13_eng_2 = "Tracking Profitability and Business Health You have a critical ability to monitor the financial health of a business by keeping track of its numbers. Whether it's profit, loss, or managing records, your skill ensures that the business stays on track and grows sustainably.\n\nEnsuring Financial Growth You play a key role in determining whether a business is profitable or  not. By analyzing profits, losses, and overall financial trends, you provide essential insight into what the company needs to grow or stay competitive.\n\nKeeping Detailed Records Your ability to manage detailed records helps the business track its financial history. This is crucial for making informed decisions on pricing, future investments, and product development. People trust businesses with a clear history, and you ensure that this trust is well-earned.\n\nMaintaining Trust through Data By keeping accurate and reliable records, you give customers confidence in the business. Companies with a solid track record inspire confidence and credibility. Your role in ensuring financial accuracy is essential for building long-term trust.\n\nUsing Your Skill in Business In business, your skill is valuable in roles related to finance, bookkeeping, and management. Your expertise in monitoring profits, managing financial records, and providing crucial business insights ensures that the organization remains on solid financial ground.";

var guclu_yanlarin_33_eng_1 = "Operations Overseer";
var guclu_yanlarin_33_eng_2 = "Ensuring Smooth Operations You have the unique ability to oversee the entire operation, ensuring everything runs smoothly. Your presence ensures that tasks are completed correctly, deadlines are met, and everyone knows what they are supposed to be doing. Your eye for detail helps maintain order and efficiency across the organization.\n\nLearning from the Past By observing and learning from past experiences, you’re able to apply valuable lessons that lead to success in the future. Your ability to reflect on what has and hasn’t worked before helps prevent mistakes and improve processes.\n\nEnsuring Accountability Your oversight helps people stay accountable for their work. You ensure that tasks are completed as planned and that any challenges are addressed. Your ability to watch over and check on progress ensures that no detail is missed and keeps the group on track.\n\nUsing Your Skill in Business In business, your ability to oversee operations and manage details is valuable in roles like team leadership or management. You can create policies, handle complaints effectively, and foster a sense of loyalty within your team. Your skill ensures that everything is done on time and to the highest standard, driving productivity and growth.";
...
var kslk_ozl_researcher_eng_your_profile = "Investigative";
var kslk_ozl_researcher_eng_your_profile_ = "Enjoy work that involves solving complex problems. You may like exploring ideas, conducting research and looking at theories. You may prefer thinking over doing and prefer data and ideas to people.";
var kslk_ozl_researcher_eng_your_interests_1 = "Investigative people are inquisitive, analytical, and intellectual. They like investigating things and solving complex problems. Investigative individuals enjoy exploring ideas, conducting research, uncovering facts and establishing theories. Their preferred reading material includes scientific or technical magazines.";
var kslk_ozl_researcher_eng_your_interests_2 = "They also enjoy working alone, and prefer working with data and ideas over people. As a result, they tend to avoid jobs that require leading, selling, or persuading others. While they share some of the same interests in the physical world as Realistic people, Investigative types prefer thinking over doing.";
var kslk_ozl_researcher_eng_strengths = "Understanding and solving science and math problems; analytical, observant, inquisitive; organizing, analyzing, interpreting data, ideas, theories; working independently with loosely defined problems; researching and understanding the physical world";
var kslk_ozl_researcher_eng_hobbies = "Scientific, mathematical, and intellectual pursuits; researching and understanding the physical world; using computers; doing complex calculations; astronomy, crossword puzzles, board games, and visiting museums.";
var kslk_ozl_researcher_eng_your_work_areas = "Biology, chemistry, physics, computer programing, computer engineering, medicine, pharmacology, psychology, veterinary science, technical writing.";
var kslk_ozl_researcher_eng_you_may_not_like = "Sales, persuading others, leading people";
var kslk_ozl_12_25_researcher_eng_questions_1 = "• How do I approach solving tough questions? How can I use this problem-solving skill more often in class?\n\n• How does learning new things and researching motivate me? How can I use my research skills more effectively in projects or assignments?\n\n• When I’m mentally challenged by a subject, how deep do I like to go in learning? In which areas at school can I further develop this curiosity?";
var kslk_ozl_25_plus_researcher_eng_questions_1 = "• What problem-solving methods do I use when I face challenging problems? How can I apply this analytical thinking skill more frequently at work?\n\n• How do detailed investigations make a difference in my job? How can I leverage this curiosity more in my work?\n\n• When I dive deep to solve a complex problem, which skills do I develop? How can I highlight these problem-solving skills more in my job?";
...
var kslk_ozl_12_25_social_eng_questions_1 = "• How do I feel when I help a friend solve their problem? How can I use this helping skill more effectively in school events?\n\n• How does a group project move forward when I motivate my friends? How can I apply this motivational strength more in school projects?\n\n• How does understanding what others need give me advantages in school life? How can I develop this empathy further?";
var kslk_ozl_25_plus_social_eng_questions_1 = "• When I help or guide my colleagues, which skills of mine stand out? How can I utilize this helpfulness more in my professional life?\n\n• How do I influence the progress of work when I motivate others in team projects? How can I reflect this ability in more projects?\n\n• How does understanding others’ needs and providing suitable solutions benefit my work? What can I do to strengthen this empathy further in the workplace?";

var kslk_ozl_entrepreneur_eng_your_profile = "Entreprise";
var kslk_ozl_entrepreneur_eng_your_profile_ = "Enjoy work activities that have to do with starting up and carrying out projects, especially business ventures. You may like persuading and leading people and making decisions. You may like taking risks for profit. You might prefer action rather than thought.";
var kslk_ozl_arentrepreneur_eng_your_interests_1 = "Enterprising people enjoy business activities and deal making. They are self-confident, assertive, persuasive, and energetic. Verbally skilled, Enterprising individuals use these skills to persuade people, unlike Social individuals who use their verbal skills to support others. They enjoy selling things, promoting ideas and influencing people.";
var kslk_ozl_entrepreneur_eng_your_interests_2 = "They also value status and prestige and search out occupations that can meet these desires. Enterprising people are also competitive and willing to take risks. As a result, they have an entrepreneurial nature and like initiating projects and convincing others to jump on board. Enterprising individuals enjoy working with people and data over things and ideas.";
var kslk_ozl_entrepreneur_eng_strengths = "seeking out business opportunities; directing, managing, supervising; selling and persuading";
var kslk_ozl_entrepreneur_eng_hobbies = "discussing politics, reading business journals, following the stock market, operating a home business";
var kslk_ozl_entrepreneur_eng_your_work_areas = "Business management, sales, politics, small business owner, real estate";
var kslk_ozl_entrepreneur_eng_you_may_not_like = "working alone, focusing on intellectual pursuits, doing complex calculations, scientific and mathematical activities";
var kslk_ozl_12_25_entrepreneur_eng_questions_1 = "• How do I feel when I lead and direct a group project? In which school projects can I use this leadership skill more often?\n\n• What do I achieve when I persuade and motivate others? How can I use this persuasion skill more frequently in school activities?\n\n• When I make a difficult decision, how do its outcomes affect me? How can I manage risk-taking better in school?";
var kslk_ozl_25_plus_entrepreneur_eng_questions_1 = "• What outcomes do I achieve when I lead decision-making processes? In which areas at work can I apply this leadership skill more often?\n\n• How does motivating and directing others impact the progress of projects? What strategies can I use to apply this motivational ability more effectively at work?\n\n• In situations that require taking risks, what strategies do I use, and how do I evaluate the results? What can I do to improve my risk management?";

var kslk_ozl_traditional_eng_your_profile = "Conventional";
var kslk_ozl_traditional_eng_your_profile_ = "Enjoy work activities that follow set procedures and routines. You may prefer working with data and detail more than with ideas. Also you might prefer work in which there are precise standards rather than make judgements. You might like working where the lines of authority are clear.";
var kslk_ozl_traditional_eng_your_interests_1 = "Conventional people are methodical, conscientious and efficient. They are accurate and like to follow clearly defined procedures. At work they enjoy rules and regulations that keep things running smoothly. They prefer structure and order to ambiguity. As a result they work well within systems or large organizations.";
var kslk_ozl_traditional_eng_your_interests_2 = "Conventional people have high standards for themselves, are accurate, and pay close attention to details. Conventional individuals are interested in data and things, rather than people. As a result, they prefer to work with the paper and computer based aspects of a business such as accounting, record keeping, and data processing.";
var kslk_ozl_traditional_eng_strengths = "working with numbers, processing information, accuracy, organizing, business writing";
var kslk_ozl_traditional_eng_hobbies = "managing personal finances, collecting memorabilia, writing family history, building models, playing computer or card games";
var kslk_ozl_traditional_eng_your_work_areas = "accounting, banking and finance, clerical/ secretarial, business administration, insurance – adjuster/underwriter";
var kslk_ozl_traditional_eng_you_may_not_like = "ambiguous, unstructured activities; dealing with interpersonal issues; drawing, painting, creative writing, photography; activities that involve self expression";
var kslk_ozl_12_25_traditional_eng_questions_1 = "• How organized do I feel when studying or doing homework? How can I use this organized work habit more effectively during exam periods?\n\n• Do I do a better job when I pay attention to details? How can I use this attention to detail more in projects and assignments?\n\n• Can I manage my time better when I plan things out? How can I use this planning skill more in my school life?";
var kslk_ozl_25_plus_traditional_eng_questions_1 = "• How much more efficiently do I complete tasks when I work in an organized and systematic way? How can I expand this habit of organized work to larger projects?\n\n• What differences does my attention to detail make in the workplace? How can I use this attention more effectively in my projects?\n\n• How do I better manage my time at work when I am planned and organized? How can I apply this planning skill more broadly in my professional life?";
...
//----
  ...
  let communication = (communicationData, age, type) => {
    if (type == "name") {
      ...
      if (communicationData == "Generator" || communicationData == "Manifesting Generator") {
        ...
        return communication_projector_s3;
      } else if (communicationData == "Manifestor") {
        return communication_manifestor_s3;
      } else if (communicationData == "Reflector") {
  ...
  } else if (type == "s3_x_1") { //TEMPLATE BURASI YAZILMIYOR. name yeterli
      if (decisionStrategyData.strategy == "To Respond" && decisionStrategyData.innerAuthority == "Emotional") {
